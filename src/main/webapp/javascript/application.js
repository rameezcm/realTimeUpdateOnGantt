angular.module('ganttUpdate', ['angular.atmosphere', 'gantt', 'gantt.table', 'gantt.movable','cgNotify']).controller('angularGanttCtrl', ChatController);


function ChatController($scope, atmosphereService ,notify){
  ...
  $scope.registerApi = function(api) {
	  ...
	  api.core.on.ready($scope, function () {
          api.tasks.on.moveEnd($scope, addEventName('tasks.on.moveEnd', function (eventName, data) {
              ...
              socket.push(atmosphere.util.stringifyJSON(data.model));
